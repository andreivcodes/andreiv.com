...
<div style="max-width: 800px; margin: auto; padding: 20px;">
  ...
  <div style="font-size: 1.2rem; line-height: 1.6; text-align: left;">
    ...
    <p><strong>open source is non negotiable</strong> — no black boxes allowed.</p>
  </div>
</div>
...
<div style="margin: auto; padding: 20px; width: 100%">
  ...
  <div style="display: flex; flex-direction: row; gap: 40px; align-items: center; justify-content: space-between;">
